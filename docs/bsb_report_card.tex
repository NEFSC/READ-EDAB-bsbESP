...
\tightlist
\item
  Steady or increasing availability; concerns about high discards
\item
  Restrictive and complex regulations limit fishing opportunities
\item
  For additional information, see MAFMC (2024a), MAFMC (2024c), and
  MAFMC (2024d)
\end{itemize}
...
2024 EAFM risk assessment update} (MAFMC 2024b), Black Sea Bass scored
...
Fratantoni, Paula Sue, Tamara Holzwarth, and Maureen H. Taylor. 2015.
{``Description of Oceanographic Conditions on the Northeast {U}.{S}.
Continental Shelf During 2014.''}
\url{https://repository.library.noaa.gov/view/noaa/5047}.

\bibitem[\citeproctext]{ref-jeanmichel_copernicus_2021}
Jean-Michel, Lellouche, Greiner Eric, Bourdallé-Badie Romain, Garric
Gilles, Melet Angélique, Drévillon Marie, Bricaud Clément, et al. 2021.
{``The {Copernicus} {Global} 1/12° {Oceanic} and {Sea} {Ice} {GLORYS12}
{Reanalysis}.''} \emph{Frontiers in Earth Science} 9 (July): 698876.
\url{https://doi.org/10.3389/feart.2021.698876}.

\bibitem[\citeproctext]{ref-mafmc_black_2024}
MAFMC. 2024a. {``Black {Sea} {Bass} {Fishery} {Information}
{Document}.''}
...
\bibitem[\citeproctext]{ref-mafmc_midatlantic_2024}
---------. 2024b. {``Mid-{Atlantic} {EAFM} {Risk} {Assessment}: 2024.''}
...
---------. 2024c. {``Summer {Flounder}, {Scup}, and {Black} {Sea} {Bass}
...
---------. 2024d. {``Summer {Flounder}, {Scup}, and {Black} {Sea} {Bass}
{Monitoring} {Committee} ({MC}) {November} 19, 2024 {Webinar} {Meeting}
{Summary} 2025 {Recreational} {Management} {Measures}.''}
...
NEFSC. 2023. {``Report of the {Black} {Sea} {Bass} ({Centropristis}
Striata) {Research} {Track} {Stock} {Assessment} {Working} {Group}.''}
...
Tabandera, Ricky, Abigail Tyrell, Marissa McMahan, and Patricia Perez.
2024. {``Black Sea Bass Ecosystem Considerations and Indicator
Development.''} \url{https://doi.org/10.25923/EZ9G-AF05}.
